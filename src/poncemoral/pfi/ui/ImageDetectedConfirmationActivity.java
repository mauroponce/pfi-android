...
import poncemoral.pfi.service.RecognitionService;
		...
		btnConfirmDetectedImage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!nearestStudents.isEmpty()) {
					...
					Toast.makeText(ImageDetectedConfirmationActivity.this, "No se detectó ningún rostro, tome otra fotograf�a.",
							Toast.LENGTH_LONG).show();
